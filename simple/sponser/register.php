...
if(isset($_POST['register'])){
    ...
    $query='INSERT INTO admin(`adminname`,`email`,`password`,`photo`)VALUES(:adminname,:email,:password,:photo)';
    ...
    if ($response){
        ...
        $message="Admin registration unsuccessful";
    }
}
?>
...
<div class="container">
    ...
    <form class="form-signin"  action="" method="post" enctype="multipart/form-data">
        ...
        <input type="text" id="inputAdminname" class="form-control mb-3 w-50" name="adminname" placeholder="Adminname" required>
